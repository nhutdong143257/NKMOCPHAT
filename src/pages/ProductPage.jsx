...
const ProductPage = () => {
  ...
  if (loading) {
    return (
      <>
        <Helmet>
          <title>Sản Phẩm In Ấn | Công Ty In Ấn Mộc Phát</title>

          <meta
            name="description"
            content="Khám phá các sản phẩm in ấn chất lượng của Mộc Phát tại TP.HCM."
          />

          <link rel="canonical" href="https://nkmocphat.com/san-pham" />
        </Helmet>
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Khám phá các sản phẩm in ấn của Mộc Phát như namecard, tờ rơi, catalogue, poster và nhiều sản phẩm in theo yêu cầu tại TP.HCM."
        />
        ...
        <meta
          property="og:title"
          content="Sản Phẩm In Ấn | Công Ty In Ấn Mộc Phát"
        />
        ...
        <meta property="og:url" content="https://nkmocphat.com/san-pham" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto leading-7">
            Khám phá các sản phẩm in ấn chất lượng của Mộc Phát, đáp ứng nhu cầu
            của doanh nghiệp và cá nhân tại TP.HCM.
          </p>

          <div className="w-24 h-1 bg-lime-600 mx-auto mt-5 rounded-full" />
        </div>
        ...
        {!hasResults ? (
          ...
          categories.map((cate, cateIndex) => {
            ...
            if (!productByCate || productByCate.length === 0) {
              return null;
            }

            const visible = visibleCounts[cate.id] ?? PER_PAGE;
